# Build Book One Part V continuous MS (Ch 58–71) — v7 assembly
...
Set-Content -Path (Join-Path $base "058-071_part_v_continuous_v7_PUBLISHER.md") -Value $out -NoNewline
Write-Host "Wrote 058-071_part_v_continuous_v7_PUBLISHER.md ($($files.Count) units)"
